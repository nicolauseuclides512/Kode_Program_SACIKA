...
const SidebarRail = SidebarPrimitive.Rail
...
const SidebarGroup = SidebarPrimitive.Group

const SidebarGroupLabel = SidebarPrimitive.GroupLabel

const SidebarGroupContent = SidebarPrimitive.GroupContent
...
const SidebarInput = SidebarPrimitive.Input
